...
public class RemoveGreater extends AbstractCommand implements Serializable {
    ...
    public void aboutCommand(){
        System.out.println("remove_greater {element}    - remove a new item from the collection if it's value is greater than the"+
    ...
    public void execute(String[] args) throws IOException{
        if(args.length != 1){
            System.out.println("Client: Invalid command's format! Fail to execute RemoveGreater command!");
        }
        else{
